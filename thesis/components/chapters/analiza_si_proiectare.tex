...
\begin{figure}[htbp]
	...
	\caption{Diagrama use-case UML a sistemului de supraveghere inteligentă, cu actorii Administrator și Operator în raport cu cele 10 cerințe funcționale, grupate pe domenii (detecție AI, interacțiune cu utilizatorul, administrare).}
	\label{fig:usecase}
\end{figure}
