...
\begin{description}
    ...
    \begin{itemize}
        ...
        \item \texttt{har\_system} -- recunoaștere acțiuni umane folosind \textbf{SlowFast-R50} (clipuri de 64 cadre, două căi slow/fast), care clasifică fiecare clip în acțiunile \texttt{normal}, \texttt{fight} și \texttt{vandalism}.
    \end{itemize}
