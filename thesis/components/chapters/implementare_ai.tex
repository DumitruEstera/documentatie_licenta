...
Detecția fețelor și extragerea descriptorilor numerici (vectori de caracteristici) sunt realizate
...
\begin{itemize}
    ...
    o avea în datasetul de origine, iar partițiile omonime din cele două surse sunt concatenate;
    \item \textbf{Negative samples} -- exemplele negative nu necesită niciun tratament special
    în scriptul de antrenare. O imagine este copiată în datasetul final chiar dacă fișierul ei de
...
ale datasetului combinat, distribuția este de aproximativ \textbf{70\,\% antrenare} (10.041 imagini),
