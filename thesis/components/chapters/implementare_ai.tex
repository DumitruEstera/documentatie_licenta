...
\begin{figure}[htbp]
	...
	\caption{\textbf{Cascada de filtrare foc/fum.} Detecțiile YOLOv10 parcurg cinci etape: încredere, dimensiune, analiză HSV, agregare temporală IoU și \textit{cooldown}. Rezultatele sunt progresiv respinse (gri), în așteptare (portocaliu), confirmate vizual (verde) sau marcate ca alertă (roșu). Indicatorii \texttt{confirmed} și \texttt{alert} separă starea validată de evenimentul declanșat.}
	\label{fig:fire_flow}
\end{figure}
