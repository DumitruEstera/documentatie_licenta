...
O mare parte dintre soluțiile comerciale disponibile în prezent sunt sisteme \emph{închise} și \emph{proprietare}. Acest model de afaceri creează o \emph{dependență puternică față de producător} și atrage după sine costuri mari pentru achiziție și licențe. Însă cel mai mare dezavantaj constă în faptul că aceste sisteme funcționează ca o „cutie neagră”: algoritmii iau decizii în fundal, iar utilizatorul nu are acces la modul lor de funcționare și nici nu le poate ajusta parametrii \cite{burrell_2016}. O astfel de rigiditate face ca sistemele să fie greu de adaptat la situații specifice sau de integrat cu echipamente deja existente, limitând flexibilitatea de care au nevoie utilizatorii.

În contrast cu această abordare, lucrarea de față își propune să demonstreze că se poate construi un sistem de supraveghere inteligent și competitiv, bazat pe principii \emph{accesibile, deschise și flexibile}. \emph{Accesibilitatea} este asigurată prin utilizarea exclusivă a tehnologiilor cu sursă deschisă (open-source) consacrate, ceea ce elimină costurile legate de licențiere \cite{hoffmann_2024}. \emph{Deschiderea} oferă transparență totală asupra fluxului de procesare a datelor, permițând verificarea fiecărei etape. Totodată, \emph{flexibilitatea} este obținută printr-o arhitectură modulară, în care diferiții algoritmi de detecție funcționează independent; aceștia pot fi activați, dezactivați sau înlocuiți cu ușurință, astfel încât sistemul să se poată adapta în timp la noile cerințe ale beneficiarului.

Utilitatea practică a unei astfel de arhitecturi poate fi observată în multiple domenii. De exemplu, în \textbf{mediul militar}, o soluție independentă elimină riscul trimiterii datelor sensibile către servere externe (cloud) \cite{shafee_2025}. În cazul \textbf{instituțiilor publice}, un sistem fără costuri de licențiere respectă bugetele alocate, dar și regulile stricte de transparență și auditare. În același timp, în \textbf{mediul privat}, arhitectura oferă libertatea de a personaliza funcționalitățile în funcție de nevoile specifice ale fiecărei afaceri.
...
\textbf{Capitolul~\ref{ch:stadiul_actual}, \emph{Stadiul actual al sistemelor inteligente de supraveghere video}}, analizează soluțiile existente pe piață și în literatura de specialitate, \linebreak evidențiind atât avantajele, cât și limitările acestora. Această trecere în revistă justifică necesitatea proiectului și clarifică poziția sistemului propus în raport cu tehnologiile actuale.
...
\textbf{Capitolul~\ref{ch:testare}, \emph{Testarea și evaluarea sistemului}}, analizează performanțele soluției dezvoltate în raport cu obiectivele inițiale. Sunt prezentate metricile de precizie ale modelelor antrenate, timpii de răspuns măsurați pe întregul flux integrat de procesare și comportamentul general al aplicației.
